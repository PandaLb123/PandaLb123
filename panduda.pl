...
print "\033[1;32m    ======================================================\n";
print "\033[1;32m         Usage: perl panduda.pl Id wordlistpass.txt \n";
print "\033[1;32m    ======================================================\n";
exit; }
...
print "\033[1;32m         ========================================================\n";
print "\033[1;32m                         BruteForce Attack Tool Presented By  : \n";
print "\033[1;32m                                    Panda Lb \n";
print "\033[1;32m         ========================================================\n";
...
{
print "\033[1;32m\n########################################################\n";
print "[+] \033[1;32mHahay la2aynelak huwe: $password\n";
print "\033[1;32m########################################################\n\n";
close SSL;
exit;
}
